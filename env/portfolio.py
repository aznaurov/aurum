...
eps = 1e-8
SDr = '2017-05-10 19:00:00'
EDr = '2018-05-10 18:00:00'
date_format = "%Y-%m-%d %H:%M:%S"
SD = datetime.strptime(SDr, date_format)

def index_to_date(index):
    return (SD + timedelta(index)).strftime(date_format)

def date_to_index(date_string):
    return (datetime.strptime(date_string, date_format) - SD).seconds//3600
...
class DataGenerator(object):
    ...
    def _step(self):
        ...
        return obs, done, ground_truth_obs, y
    ...
    def reset(self):
        ...
        if self.start_date is None:
            ...
            #print(date_to_index(self.start_date))
            #print(self.window_length, self.idx, self._data.shape[1], self.steps)
...
class PortfolioEnv(gym.Env):
    ...
    def step(self, action):
        ...
        observation, done1, ground_truth_obs, y = self.src._step()
        ...
        return observation, reward, done1 or done2, info, y
